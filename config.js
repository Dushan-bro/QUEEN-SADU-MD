...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "KEwxHDQQ#ELiqKOXhqtPFmMW2b6Fh4U9Q6Dpqsl6RcC3iUIg0C3w",
    CAPTION: process.env.CAPTION || "POWERED BY KA VI",
    ...
    BOT_NAME: process.env.BOT_NAME || "KA VI💫࿐",
